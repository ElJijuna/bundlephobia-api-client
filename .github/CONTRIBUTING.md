...
Thank you for your interest in contributing to `bundlephobia-api-client`!

## Development setup

```bash
git clone https://github.com/ElJijuna/bundlephobia-api-client.git
cd bundlephobia-api-client
npm install
```
